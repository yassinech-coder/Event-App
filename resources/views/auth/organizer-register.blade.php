...
@section('content')
   <div class="album text-muted">
    ...
    <div class="site-section bg-light col-md-10">
        <br>
        <h1 style="margin-left: 15px"> Organizer Registration</h1>
        <br>
      <div class="container">
        <div class="row justify-content-center">
       ...
       @if(Session::has('message'))
          ...
          <div class="col-md-10 ">
            ...
            <form method="POST" action="{{ route('org.register') }}" class="p-5 bg-white">
                        @csrf
              ...
              <div class="row form-group">
                <div class="col-md-10">
                  <input type="submit" value="Register as Organizer" class="btn btn-primary  py-2 px-5" style="width: 100%">
                </div>
              </div>
