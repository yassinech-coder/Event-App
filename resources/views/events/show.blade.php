...
<br><br><br><br><br>
      ...
      @endif
                    ...
                    <form action="{{ route('comments.storeReply', $comment) }}" method="POST" class="mb-3 ml-5 d-none"
                        ...
                        <table>
                            <div class="form-group">
                                ...
                                <tr>
                                    <th style="width: 3%"></th>
                                    <th style="width: 85%"> <textarea name="replyComment" style="border-radius: 5px; width:100%"
                                            class="form-control @error('replyComment') is-invalid @enderror" id="replyComment"
                                            rows="2"></textarea>
                                        @error('replyComment')
        ...
        @foreach ($eventRecommendations as $eventRecommendation)
           <th> <div class="card" style="width: 18rem;margin-right:15px">
                <div class="card-body">
