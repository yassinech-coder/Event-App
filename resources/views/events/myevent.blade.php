            ...
            <table class="table">
                ...
                <thead><br>
                    <a href="{{route('event.create')}}">
                       <button class="btn btn-dark py-2 px-3 " style=" margin-bottom: 20px;margin-left: 10px;  " > Post Event </button></a>
                        <br>
                ...
                <tbody>
                    ...
                    <br>
                    <button class="btn btn-danger btn-m mb-1" onclick="handleDelete({{$event->id}})"  style="width: 90%">Delete</button>
                </td>
            </tr>
            @endforeach
        </tbody>
