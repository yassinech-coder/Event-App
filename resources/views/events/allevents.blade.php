                    ...
                    <table>
                        ...
                        <thead style="margin-bottom: 20px">
                            <form action="{{ 'allevents' }}" method="GET">
                                <th style="width: 6%"></th>
                                <th>title</th>
                                <th><input style="height: 37px;width:150px" type="text" name="title" class="form-control ">
                                </th>
                                <th style="width: 1%"></th>
                                <th> category</th>
                                ...
                                <th style="width: 1%"></th>
                                <th>location</th>
                                <th><input style="height: 37px;width:150px" type="text" name="location"
                                        class="form-control"></th>
                                <th style="width: 1%"></th>
                                <th>date</th>
                                <th><input style="height: 37px;width:170px" type="date" class="form-control" name="date">
                                </th>
                                <th style="width: 2%"></th>
                                <th>
                                ...
                                @foreach ($events as $event)
                                    <tr>
                                        <td>
                                            ...
                                            @else
                                                <img src="{{env('APP_STORAGE')}}{{ '/storage/articles/' . $event->picture }}" width="200">
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ route('events.show', [$event->id, $event->title]) }}">
                                                <button
                                                    class="btn btn-secondary rounded py-2 px-3 float-right">Check</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
