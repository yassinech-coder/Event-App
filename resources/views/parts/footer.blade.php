    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>Event management is the application of project management in the creation and development of small
                    or large personal or company events.It involves researching the brand, identifying the target
                    audience, designing and coordinating the technical aspects before actually
                    launching the campaign</p>
        ...
        <div class="row pt-5 mt-5 text-center">
            <div class="col-md-12">
                <p>
                    ...
                    </script> All Rights Reserved | This website is made with <i class="icon-heart text-warning"
